...
button_clear1 = Button(root, text='clear', padx=79, pady=20, command=button_clear)
button_equal1 = Button(root, text="=", padx=185, pady=20, command=button_equal)
...
button_equal1.grid(row=5, column=0, columnspan=5)
button_clear1.grid(row=4, column=1, columnspan=2)

# myButton = Button(root, text="Enter your Stock Quote", command=my_click)
